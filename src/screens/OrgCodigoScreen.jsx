...
export default function OrgCodigoScreen() {
  ...
  return (
    <div className="screen">
      <div className="header"><span className="header-title">Organização Criada</span></div>
      <div className="content">
        ...
        <p style={{ fontSize: '13px', color: 'var(--text2)', textAlign: 'center', marginBottom: '24px', lineHeight: 1.5 }}>Partilha este código com os líderes da tua igreja.</p>
        <button className="btn-primary btn-accent" onClick={() => entrarNaApp(membroAtual, organizacaoAtual)}>Continuar <Icon name="arrow-right" size={18} color="var(--accent-text)" /></button>
      </div>
    </div>
  )
}
