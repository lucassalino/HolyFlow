      ...
      <div className="content">
        <div className="codigo-display" style={{ marginBottom: '8px' }}>
          ...
          <div style={{ marginTop: '16px', display: 'flex', gap: '8px' }}>
            <button className="btn-primary" onClick={copiarCodigo} style={{ flex: 1, padding: '11px', fontSize: '13px', gap: 6 }}>
              <Icon name="copy" size={16} /> Copiar
            </button>
            <button className="btn-primary" onClick={partilharCodigo} style={{ flex: 1, padding: '11px', fontSize: '13px', gap: 6 }}>
              <Icon name="share" size={16} /> Partilhar
            </button>
          </div>
        </div>
        <p style={{ fontSize: '12px', color: 'var(--text3)', textAlign: 'center', marginBottom: '20px' }}>
          Partilha este código — os líderes pedem acesso e tu aprovares aqui.
        </p>
