    ...
    <div className="screen">
      ...
      <div className="content">
        ...
        <div className="campo">
          ...
          <input type="text" value={codigo} onChange={e => setCodigo(e.target.value.toUpperCase())} onKeyDown={e => e.key === 'Enter' && entrar()} placeholder="Ex: IGREJA-X7K2" style={{ textTransform: 'uppercase', letterSpacing: '2px', fontWeight: 600 }} />
        </div>
